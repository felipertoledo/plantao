...
function routeFromHash() {
  ...
  if (parts[0] === "consulta") return window.renderConsulta && window.renderConsulta();
  if (parts[0] === "receituario") return window.renderReceituario && window.renderReceituario();
  if (parts[0] === "prefs") return window.renderPrefs && window.renderPrefs();
...
function renderSobre() {
  ...
  document.getElementById("view").innerHTML = `
    <section class="container small">
      ...
      <div class="block">
        <h2>Quem fez isto</h2>
        <p>Felipe Ribeiro Toledo (vovôminic) — médico e nerd usando o tempo que deveria estar estudando para residência com coisas aleatórias.</p>
      </div>
