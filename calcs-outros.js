...
CALCS.push(
{
id:"apache-simp", contexto:["pa"], nome:"APACHE II — Simplificado", sis:"iot",
...
{id:"apgar", contexto:["pa","ubs"], nome:"APGAR — Avaliação do Recém-Nascido", sis:"gest",
...
{
id:"audit-c", contexto:["pa","ubs"], nome:"AUDIT-C — Rastreio Álcool", sis:"ubs",
...
{id:"cam-icu", contexto:["pa"], nome:"CAM-ICU — Delirium em UTI", sis:"iot",
...
{
id:"ciwa", contexto:["pa","ubs"], nome:"CIWA-Ar (abstinência alcoólica)", sis:"tox",
...
{id:"ciwa-ar", contexto:["pa","ubs"], nome:"CIWA-Ar — Abstinência Alcoólica", sis:"psiq",
...
/* ========== RECUPERADOS (perdidos na reorganização nível 3) ========== */

{
id:"ped-dose", contexto:["pa"], nome:"Dose pediátrica", sis:"iot",
...
{
id:"gotas", contexto:["pa"], nome:"Gotas/min", sis:"iot",
...
{
id:"vaso-bic", contexto:["pa"], nome:"Infusão de vasoativa (BIC)", sis:"vaso",
...
{
id:"imc", contexto:["pa","ubs"], nome:"IMC — Índice de Massa Corporal", sis:"ubs",
...
{
id:"rass", contexto:["pa"], nome:"RASS — Sedação UTI", sis:"iot",
...
{
id:"phq9", contexto:["pa","ubs"], nome:"PHQ-9 — Rastreio Depressão", sis:"ubs",
...
{id:"mews", contexto:["pa"], nome:"MEWS — Modified Early Warning Score", sis:"iot",
...
{id:"news2", contexto:["pa"], nome:"NEWS2 — National Early Warning Score 2", sis:"iot",
...
{id:"ottawa", contexto:["pa","ubs"], nome:"Ottawa Ankle/Foot Rules — Indicação de RX", sis:"ost",
...
{
id:"framingham", contexto:["pa","ubs"], nome:"Framingham — Risco CV em 10 anos", sis:"ubs",
