...
D) ASSOCIAÇÃO COM CESSAÇÃO DO TABAGISMO — INSEPARÁVEL:
  ...
  • PNCT: oferece TRN (adesivo 21/14/7 mg, goma 2-4 mg, pastilha 1-2 mg), BUPROPIONA SR 150 mg/dia × 3d → 150 mg 12/12h por 7-12 sem, VARENICLINA 0,5 mg/dia × 3d → 0,5 mg 12/12h × 4d → 1 mg 12/12h por 12 sem
...
B) VIGILÂNCIA DIRIGIDA — alto risco:
  ...
  2) H. PYLORI:
     • ERRADICAR em todo paciente diagnosticado (PCDT MS) — ESQUEMAS:
       — 1ª LINHA (triplo padrão, 14 dias): CLARITROMICINA 500 mg VO 12/12h + AMOXICILINA 1 g VO 12/12h + OMEPRAZOL 20-40 mg VO 12/12h por 14 dias (UBS — amoxi/omeprazol; claritro FARMASUS/PFPB)
       — Em ALERGIA À PENICILINA: substituir amoxicilina por METRONIDAZOL 500 mg VO 12/12h (UBS)
       — 2ª LINHA / FALHA (quádruplo com bismuto, 14 dias): SUBCITRATO/SUBSALICILATO DE BISMUTO 120-240 mg VO 6/6h + TETRACICLINA 500 mg VO 6/6h + METRONIDAZOL 500 mg VO 8/8h + OMEPRAZOL 20-40 mg VO 12/12h por 14 dias (bismuto não está no SUS na maioria dos municípios — particular)
       — 3ª LINHA (após 2 falhas): orientação por gastroenterologia + teste de susceptibilidade quando disponível
...
A) CESSAÇÃO DO TABAGISMO — INTERVENÇÃO MAIS EFETIVA:
  ...
  • PNCT no SUS: tratamento gratuito disponível
    ...
    - Terapia de reposição de nicotina (TRN): adesivo 21/14/7 mg/dia × 6+2+2 sem, goma 2-4 mg PRN, pastilha 1-2 mg PRN
    - BUPROPIONA SR 150 mg/dia × 3 d → 150 mg 12/12h por 7-12 sem, VARENICLINA 0,5 mg/dia × 3d → 0,5 mg 12/12h × 4d → 1 mg 12/12h por 12 sem (segundo critérios de inclusão)
...
I) IMUNOSSUPRIMIDOS NÃO-HIV — protocolos similares:
  ...
  • RITUXIMABE (anti-CD20 — 375 mg/m² IV semanal × 4 ou 1000 mg IV × 2 com 14 dias de intervalo conforme indicação): risco de linfoma, infecções (especialmente reativação HepB, JCV-LEMP)
