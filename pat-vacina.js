...
sus_tx:"Vacina antirrábica + soro/IGHAR: distribuídos via PNI nas UBS habilitadas + Unidade Centro de Zoonoses + PS de referência. Localmente: Unidade Centro de Zoonoses Municipal (Centro de Zoonoses Municipal) ou SAE regional — CONFIRMAR fluxo local. Encaminhamento para PS regional se exposição grave (município regional). Notificar SINAN.",
...
sus_tx:"SAE municipal ou regional (SAE município regional — CONFIRMAR). UBS quando habilitada. IGHAHB: distribuída via CRIE com indicação. Sorologias do acidentado e da fonte: HBsAg, anti-HBs, anti-HCV, anti-HIV (testes rápidos). Iniciar PEP-HIV concomitante se indicado (ver patologia separada vac-hiv-pep). Notificar SINAN (acidente biológico) + Vigilância Epidemiológica local.",
...
sus_tx:"SAE municipal/regional 24h (não-feriado). Em horário não-comercial: PS de referência. Para SAE de município regional (CONFIRMAR). MS distribui kit PEP HIV gratuitamente. Para violência sexual: maior parte dos PS tem kit pronto (PEP + contracepção emergência + ATB IST). Notificação obrigatória de violência sexual (SINAN ficha de notificação compulsória).",
