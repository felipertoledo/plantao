...
{id:"med-sacubitril-valsartana", contexto:["ubs"], classe:"ARNI — inibidor neprilisina + BRA (sacubitril+valsartana)", grupo:"antihipertensivo",
nome:"Sacubitril + Valsartana (Entresto)",
sin:["LCZ696","Entresto"],
formas:["Comprimidos 24/26 mg, 49/51 mg, 97/103 mg — privada / CEAF em alguns estados (PCDT IC)"],
resumo:"ARNI — combinação de inibidor de neprilisina (sacubitril) + BRA (valsartana). Substitui IECA/BRA em IC com FE REDUZIDA. PARADIGM-HF: superioridade clara vs enalapril em mortalidade CV e hospitalização por IC. PCDT IC moderna inclui como pilar.",
dose_rapida:"49/51 mg VO 2×/d (dose inicial usual); titular para 97/103 mg 2×/d",
doses:[
{ind:"Insuficiência cardíaca com FE REDUZIDA (FE ≤40%) — em paciente já em IECA/BRA estável", dose:"Iniciar 49/51 mg VO 2×/d; titular em 2-4 sem para 97/103 mg 2×/d (dose alvo)", obs:"REQUER washout de 36h após última dose de IECA. NÃO usar IECA junto (risco angioedema)."},
{ind:"IC FE reduzida — paciente sem IECA prévio ou IC novo / hospitalizado", dose:"Iniciar 24/26 mg 2×/d; titular gradual", obs:"Em paciente naive, iniciar dose baixa. PIONEER-HF: pode iniciar durante internação."},
{ind:"IC FE preservada ou levemente reduzida (FE >40%)", dose:"Mesmas doses", obs:"PARAGON-HF: benefício borderline; alguns guidelines incluem em FE 41-50%."},
],
ajustes:{
irc:"TFG ≥30: dose padrão. TFG <30: cautela; iniciar 24/26 mg. TFG <15: contraindicação relativa.",
iht:"Child-Pugh A/B: cautela. Child-Pugh C: CONTRAINDICADO.",
idoso:"Iniciar baixa dose, titular lentamente.",
gestante:"CATEGORIA D — CONTRAINDICAÇÃO (BRA é teratogênico).",
aleita:"Não usar.",
ped:"Não rotineiro.",
},
mecanismo:"Sacubitril (pró-fármaco) → sacubitrilato (inibidor de neprilisina) → bloqueia degradação de peptídeos natriuréticos (BNP, ANP) → aumenta diurese, natriurese, vasodilatação. Valsartana bloqueia angiotensina II.",
farmacocin:{absorc:"VO boa", distrib:"Ampla", metab:"Hepático", elimin:"Renal e fecal", meiavida:"Sacubitrilato ~11h; valsartana ~10h", ligacao:"Alta"},
espectro:["IC FE reduzida (1ª linha)","IC FE levemente reduzida","Hipertensão refratária (off-label)"],
interacoes:[
{droga:"IECA", efeito:"CONTRAINDICAÇÃO ABSOLUTA — risco de angioedema. Washout de 36h."},
{droga:"BRA isolado (losartana, etc.)", efeito:"Não combinar — bloqueio duplo do mesmo eixo."},
{droga:"AINEs", efeito:"Risco IRA + redução de efeito anti-HAS."},
{droga:"Lítio", efeito:"Aumenta níveis."},
{droga:"Espironolactona / eplerenona", efeito:"Risco de hipercalemia — monitorar K+."},
],
efeitos:[
{tipo:"comum", item:"Hipotensão (especialmente em paciente em IECA prévio — washout reduz), hipercalemia, tosse rara (sacubitril não causa, mas valsartana pode), tontura"},
{tipo:"sério", item:"ANGIOEDEMA (incidência baixa mas maior que enalapril em afrodescendentes), insuficiência renal aguda, hipotensão sintomática grave"},
],
alertas:[
{nivel:"crit", txt:"<strong>WASHOUT DE 36h</strong> após última dose de IECA antes de iniciar sacubitril/valsartana — risco de angioedema. NÃO COMBINAR com IECA."},
{nivel:"crit", txt:"<strong>HISTÓRIA DE ANGIOEDEMA por IECA prévio = CONTRAINDICAÇÃO</strong> (sacubitril pode reativar)."},
{nivel:"warn", txt:"Hipotensão é a complicação mais comum no início. Em paciente com PAs &lt;100 mmHg: iniciar dose baixa, titular gradual."},
{nivel:"warn", txt:"Monitorar potássio, função renal — semelhante a IECA/BRA."},
{nivel:"info", txt:"<strong>PARADIGM-HF:</strong> superioridade clara vs enalapril em ICFEr — redução 20% em mortalidade CV + hospitalização. Mudou paradigma do tratamento de IC."},
],
preparo:"VO com ou sem alimento, mesmo horário.",
monitor:"PA, função renal, potássio, sinais de angioedema, sintomas IC.",
diretriz:"ESC IC 2021. AHA/ACC/HFSA IC 2022. PCDT MS — Insuficiência Cardíaca (em atualização).",
fluxo:null, calcs:[],
}
