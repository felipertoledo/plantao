...
sus_tx:"Controle PA: IECA (ENALAPRIL 10-20 mg 2× — UBS+PFPB) ou BRA (LOSARTANA 50-100 mg/dia — UBS+PFPB) — escolher um. Adicionar segundo agente se necessário (BCC, tiazídico em TFG ≥30, BB). Controle DM2: METFORMINA conforme TFG (até TFG 30; reduzir dose em 30-45, contraindicada <30) — UBS+PFPB. iSGLT2: DAPAGLIFLOZINA 10 mg/dia (CEAF com PCDT DRC + DM ou DRC isolada com critérios). Estatina: SINVASTATINA 40 mg (UBS+PFPB). Anemia (G3b-G5 com Hb<11): ferro VO (sulfato ferroso UBS) se ferritina baixa; EPO via CEAF/nefro se ferritina adequada e Hb<10. Acidose metabólica (G4-G5 com HCO3<22): bicarbonato de sódio VO. Hiperfosfatemia (G4-G5): restrição dietética, quelante de fósforo (CEAF). Hiperparatireoidismo: vitamina D ativa (calcitriol — CEAF).",
padrao_ouro:"Acrescenta: finerenona (antagonista mineralocorticoide não-esteroidal) em DRC+DM2 com albuminúria persistente [FIDELIO-DKD]; semaglutida em DRC+DM2 [FLOW]; preparação para terapia substitutiva (TSR) em G4 progressivo: avaliação pré-diálise/transplante, fístula AV planejada, vacinação hep B; transplante renal pré-emptivo (antes da diálise) — melhor prognóstico que diálise → transplante.",
...
padrao_ouro:"Acrescenta: tibolona (esteroide sintético com efeito estrogênico/progestagênico/androgênico — útil em mulher com baixa libido); DHEA via vaginal (Prasterona); cremes vaginais com lasers (CO2, erbium — privado, sem evidência convincente); fitoterápicos (cimicifuga racemosa — eficácia modesta; isoflavonas — evidência conflitante).",
